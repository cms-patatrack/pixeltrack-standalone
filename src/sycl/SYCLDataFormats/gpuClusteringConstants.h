#ifndef SYCLDataFormats_SiPixelCluster_interface_gpuClusteringConstants_h
#define SYCLDataFormats_SiPixelCluster_interface_gpuClusteringConstants_h
...
#endif  // SYCLDataFormats_SiPixelCluster_interface_gpuClusteringConstants_h
