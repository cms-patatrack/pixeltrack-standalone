...
namespace KOKKOS_NAMESPACE {
  ...
  void PixelCPEFastESProducer::produce(edm::EventSetup &eventSetup) {
    ...
    Kokkos::View<pixelCPEforGPU::CommonParams, KokkosExecSpace> commonParams_d("commonParams_d");
    ...
    Kokkos::View<pixelCPEforGPU::DetParams *, KokkosExecSpace> detParams_d("detParams_d", ndetParams);
