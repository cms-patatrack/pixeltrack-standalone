...
namespace KOKKOS_NAMESPACE {
  ...
  void PixelCPEFastESProducer::produce(edm::EventSetup &eventSetup) {
    ...
    Kokkos::View<pixelCPEforGPU::CommonParams, KokkosExecSpace> commonParams_d(
        Kokkos::ViewAllocateWithoutInitializing("commonParams_d"));
    auto commonParams_h = Kokkos::create_mirror_view(commonParams_d);
    ...
    Kokkos::View<pixelCPEforGPU::DetParams *, KokkosExecSpace> detParams_d(
        Kokkos::ViewAllocateWithoutInitializing("detParams_d"), ndetParams);
    auto detParams_h = Kokkos::create_mirror_view(detParams_d);
    ...
    Kokkos::View<pixelCPEforGPU::AverageGeometry, KokkosExecSpace> averageGeometry_d(
    ...
    Kokkos::View<pixelCPEforGPU::LayerGeometry, KokkosExecSpace> layerGeometry_d(
    ...
    Kokkos::View<pixelCPEforGPU::ParamsOnGPU, KokkosExecSpace> params_d(
    ...
    eventSetup.put(std::make_unique<PixelCPEFast<KokkosExecSpace>>(std::move(commonParams_d),
