...
namespace gpuClustering {
  ...
  void clusterChargeCut(
      Kokkos::View<uint16_t*, MemSpace> id,                 // module id of each pixel
      Kokkos::View<const uint16_t*, MemSpace> adc,          // local coordinates of each pixel
      Kokkos::View<const uint32_t*, MemSpace> moduleStart,  // index of the first pixel of each module
      Kokkos::View<uint32_t*, MemSpace> nClustersInModule,  // output: number of clusters found in each module
      Kokkos::View<const uint32_t*, MemSpace> moduleId,     // output: module id of each module
      Kokkos::View<int*, MemSpace> clusterId,               // output: cluster id of each pixel
      int numElements,
