  ...
  namespace pixelgpudetails {
    ...
    void SiPixelRawToClusterGPUKernel::makeClustersAsync(bool isRun2,
      ...
      if (wordCounter)  // protect in case of empty event....
      {
        ...
        auto word_d_view =
            cms::alpakatools::createDeviceView<uint32_t>(alpaka::getDev(queue), word_d.get(), wordCounter);
        auto fedId_d_view =
            cms::alpakatools::createDeviceView<uint8_t>(alpaka::getDev(queue), fedId_d.get(), wordCounter / 2);
