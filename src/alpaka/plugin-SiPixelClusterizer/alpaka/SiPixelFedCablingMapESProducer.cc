...
auto cablingMap_h{cms::alpakatools::createHostView<SiPixelFedCablingMapGPU>(host, &obj)};
...
auto modToUnp_h{cms::alpakatools::createHostView<unsigned char>(host, modToUnpDefault.data(), modToUnpDefSize)};
