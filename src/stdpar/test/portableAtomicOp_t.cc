...
int main() {
    ...
    for(int i = 0 ; i < 5 ; ++i) {
        ...
        std::cout << "parallel exec time: " << std::chrono::duration_cast<std::chrono::milliseconds>(e - s).count() << "ms" << std::endl;
        ...
        *result = std::numeric_limits<int>::max();
        ...
        std::cout << "seq exec time: " << std::chrono::duration_cast<std::chrono::milliseconds>(e - s).count() << "ms" << std::endl;
