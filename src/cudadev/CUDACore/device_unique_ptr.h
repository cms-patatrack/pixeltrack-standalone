    ...
    namespace device {
      namespace impl {
        ...
        public:
          ...
          DeviceDeleter(DeviceAllocatorContext const &ctx) : ctx_(ctx) {}
        ...
        private:
          std::optional<DeviceAllocatorContext> ctx_;
        };
      }  // namespace impl
