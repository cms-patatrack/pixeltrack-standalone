...
public:
  ...
  void launchBrokenLineKernels(HitsView const *hv, uint32_t nhits, uint32_t maxNumberOfTuples, std::unordered_map<std::string, int> launchConfigs, cudaStream_t cudaStream);
