...
namespace cms::cuda {
  void EventCache::Deleter::operator()(sycl::event event) const {
    if (device_ != -1) {
      ...
      /*
      DPCT1027:6: The call to cudaEventDestroy was replaced with 0, because this call is redundant in DPC++.
      */
      cudaCheck(0);
    }
  }
  ...
  SharedEventPtr EventCache::makeOrGet(int dev) {
    return cache_[dev].makeOrGet([dev]() {
      ...
      /*
      DPCT1027:7: The call to cudaEventCreateWithFlags was replaced with 0, because this call is redundant in DPC++.
      */
      cudaCheck(0);
